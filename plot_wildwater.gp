...
# 2. Configuration du multiplot (2 graphiques côte à côte)
...
set ylabel ""
# Inverse l'axe Y pour que le tri soit lisible du haut vers le bas (comme sur votre exemple)
set yrange reverse 
set boxwidth 0.9 relative

# --- PLOT 1: 50 Plus Petites Usines (Barres Horizontales) ---
set title "50 Plus Petites Usines"
set origin 0.0, 0.0
set size 0.5, 1.0

# Commande : lit les 50 dernières lignes (plus petites), les inverse (tac) pour l'affichage, et les trace.
...
# --- PLOT 2: 10 Plus Grandes Usines (Barres Horizontales) ---
set title "10 Plus Grandes Usines"
set origin 0.5, 0.0
set size 0.5, 1.0

# Commande : lit les 10 premières lignes (plus grandes), les inverse (tac) pour l'affichage, et les trace.
